  ...
  const members = [
    {
      ...
      desc: "Content strategy and community building",
    },
    {
      name: "Koustab Saikia",
      role: "Coordinator",
      desc: "Content creation and engagement",
    },
    {
      name: "Bivamoni Amchi",
      role: "Coordinator",
      desc: "Social media analytics and campaigns",
    },
    {
      name: "Jyotismita Bhuyan",
      role: "Coordinator",
      desc: "Creative content and storytelling",
    },
  ];
...
const Section = ({ title, show, setShow, cols, members }) => (
  <div className="mx-auto my-8 max-w-5xl bg-black/20 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20 transition-transform hover:scale-[1.01]">
