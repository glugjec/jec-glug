  ...
  const members = [
    {
      name: "Ashish Saikia",
      role: "Co-Head",
      desc: "Driving innovation and collaboration",
    },
    {
      name: "Dorothy Gogoi",
      role: "Co-Head",
      desc: "Fostering community growth and engagement",
    },
    {
      name: "Ritu Raj Bora",
      role: "Co-Head",
      desc: "Creative Visionary and Design expert",
    },
    {
...
const Section = ({ title, show, setShow, cols, members }) => (
  <div className="mx-auto my-8 max-w-5xl bg-neutral-800/20 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-white/20 transition-transform hover:scale-[1.01]">
