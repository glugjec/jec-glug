  ...
  const members = [
    {
      name: "Rajdeep Dutta",
      role: "Coordinator",
      desc: "Sharp thinker, silent slayer",
    },
    {
      name: "Dreamsea Dutta",
      role: "Coordinator",
      desc: "Visionary, Soft Aesthetic, Sharp Minds",
    },
    {
      name: "Mriganka Mahanta",
      role: "Coordinator",
      desc: "Steady, imaginative, driven",
    },
    {
      name: "Pranjal Nath",
      role: "Coordinator",
      desc: "Energetic, witty, unstoppable",
    },
  ];

  return (
    <Section
      title="General Coordinators"
      show={show}
      setShow={setShow}
