...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-[90vh] bg-[#03022B] flex flex-col items-center justify-center overflow-hidden">
      {/* Hero stuff*/}
      <div className="relative z-20 text-center px-4 pt-24 w-full flex flex-col items-center justify-center">
        <img
          src="images/bg.png"
          alt=""
          role="presentation"
          loading="lazy"
          className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-[600px] h-auto pointer-events-none transition-all duration-1000 ease-out brightness-50
            ${circleVisible ? 'opacity-80 scale-100' : 'opacity-0 scale-95'}
            z-[-1]`}
        />
