   ...
   <div id="team-section" className="team-header text-center py-16 px-4">
      ...
      */}
      ...
      style={{
       ...
       className="bg-clip-text text-transparent font-canno text-[96px] 
        font-bold mb-4 tracking-wider">
        Our Team
      </h1>
      ...
      */}
      <p className="font-poppins mission-text text-white text-[20px] sm:text-[25px] sm:max-w-[50%] 
      ...
      */}
      <div className="text-xl font-canno session-badge inline-block bg-gray-200 border 
      border-gray-600 rounded-2xl px-6 py-3 text-gray-900 font-medium tracking-wider 
      drop-shadow-lg">
        Session 2025-2026
      </div>
    </div>
