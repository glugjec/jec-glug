...
const TeamSection = ({ title, members }) => {
    ...
    return (
      <div className="mx-auto my-8 max-w-6xl bg-black/30 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20 transition-transform hover:scale-[1.01]">
