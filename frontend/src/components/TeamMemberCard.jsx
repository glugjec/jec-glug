...
const TeamMemberCard = ({ member }) => {
  return (
    <div className="text-3xl bg-gradient-to-b from-[#000000] via-[#020202] via-[#282828] via-[#383737] via-[#444343] to-[#545353] backdrop-blur-sm rounded-xl p-5 flex flex-col space-y-12 shadow-md border border-white/10">
      <div className="flex items-center space-x-12 m-4">
        <img
